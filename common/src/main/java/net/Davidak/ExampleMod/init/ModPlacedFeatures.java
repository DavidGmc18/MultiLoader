...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> EXAMPLE_TREE_CHECKED = createKey("example_tree_checked");

    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        HolderGetter<ConfiguredFeature<?, ?>> getter = context.lookup(Registries.CONFIGURED_FEATURE);

        PlacementUtils.register(context, EXAMPLE_TREE_CHECKED, getter.getOrThrow(ModConfiguredFeatures.EXAMPLE_TREE), PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
    }
